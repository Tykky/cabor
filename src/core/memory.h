...
#define CABOR_MALLOC(size) cabor_malloc(get_global_cabor_allocator_context(), size, CABOR_MEMORY_DEBUG_STR_ALLOC)
#define CABOR_REALLOC(mem, size) cabor_realloc(get_global_cabor_allocator_context(), mem, size, CABOR_MEMORY_DEBUG_STR_ALLOC)
#define CABOR_CALLOC(num, size) cabor_calloc(get_global_cabor_allocator_context(), num, size, CABOR_MEMORY_DEBUG_STR_ALLOC)
#define CABOR_FREE(mem) cabor_free(get_global_cabor_allocator_context(), mem, CABOR_MEMORY_DEBUG_STR_DEALLOC)
